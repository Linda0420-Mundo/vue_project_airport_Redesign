        ...
        <div ref="sidebar" class="p-8 w-64">
          ...
          <div class="space-y-4">
            <button
              ...
              class="flex items-center py-3 w-full text-left border-b border-gray-200 transition-colors duration-300"
              :class="[
            ...
            >
              <font-awesome-icon :icon="transport.icon" class="mr-3 w-5" />
        ...
        <div class="p-4">
          ...
          <div class="flex overflow-x-auto pb-2 space-x-2">
            <button
              ...
              class="flex items-center px-4 py-2 whitespace-nowrap transition-colors duration-300"
              :class="[
                selectedTransport === transport.id
            ...
            >
              <font-awesome-icon :icon="transport.icon" class="mr-2" />
              {{ transport.name }}
            </button>
          </div>
        </div>
